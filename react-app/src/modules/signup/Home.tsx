...
export default class Home extends Component<HomeProps, HomeState> {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      alert('An error occurred while loading your goals.');
    } finally {
  ...
  renderGoalsList(goals: Goal[]) {
    ...
    return goalsList.concat(goals).map((goal, i) => (
      <tr key={goal.goalId}>
        <td>
  ...
  renderLanding() {
    return (
      <div className="lander">
        ...
        <hr />
        <p>
          This is a sample application that creates a simple CRUD (create, read,
          update, delete) app, and provides the foundational services,
          components, and plumbing needed to get a basic web application up and
          running. In this "goals" app, users can create goals, add
          descriptions, and update or remove their goals. You can get this
          sample application up and running in your own environment and learn
          more about the architecture of the app by looking at the{' '}
          <a
        ...
        <div className="button-container col-md-12">
          <a href="/signup" className="orange-link">
